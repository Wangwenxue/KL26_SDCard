...
void SD_Detect_Init(void)
{
    ...
    PORTD_PCR0 = PORT_PCR_MUX(1) | PORT_PCR_IRQC(0x0A) | PORT_PCR_PE_MASK | PORT_PCR_PS_MASK;//Falling edge interrupt
    
    PORTD_PCR0 |= PORT_PCR_ISF_MASK;    // Clear the IO interrupt flag
