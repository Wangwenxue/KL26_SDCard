...
//    List file    =  
//        D:\My Project\SDCardJicheng\KL25 CMSIS USB Stack MSD With
//        FatFs\kl25_sc_rev10\klxx-sc-baremetal\build\iar\KL25_USB_MSD\FLASH_128KB\List\smc.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  145   SMC_PMCTRL |=  SMC_PMCTRL_STOPM(0); 
        LDR      R1,??DataTable11_1  ;; 0x4007e001
        LDRB     R1,[R1, #+0]
        LDR      R2,??DataTable11_1  ;; 0x4007e001
        STRB     R1,[R2, #+0]
//  146   SMC_STOPCTRL &= ~SMC_STOPCTRL_PSTOPO_MASK;
        ...
        LSRS     R1,R1,#+26
        LDR      R2,??DataTable10_1  ;; 0x4007e002
        STRB     R1,[R2, #+0]
...
//  502        if ((SMC_PMSTAT & SMC_PMSTAT_PMSTAT_MASK)== 1)
        LDR      R2,??DataTable11_2  ;; 0x4007e003
        LDRB     R2,[R2, #+0]
        UXTB     R2,R2
