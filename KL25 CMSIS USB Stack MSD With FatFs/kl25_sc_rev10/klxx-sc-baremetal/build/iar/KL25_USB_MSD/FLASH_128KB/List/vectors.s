...
//    List file    =  
//        D:\My Project\SDCardJicheng\KL25 CMSIS USB Stack MSD With
//        FatFs\kl25_sc_rev10\klxx-sc-baremetal\build\iar\KL25_USB_MSD\FLASH_128KB\List\vectors.s
//
///////////////////////////////////////////////////////////////////////////////

        #define SHT_PROGBITS 0x1

        EXTERN USB0_IRQHandler
...
__vector_table:
        ...
        DC32 default_isr, default_isr, default_isr, default_isr, default_isr
        DC32 default_isr, default_isr, default_isr, default_isr, default_isr
        DC32 default_isr, USB0_IRQHandler, default_isr, default_isr
        DC32 default_isr, default_isr, default_isr, default_isr, default_isr
...
//  346    
//  347    temp = RTC_SR;
        LDR      R0,??DataTable1_1  ;; 0x4003d014
        LDR      R0,[R0, #+0]
        STR      R0,[SP, #+0]
//  348    temp++;
        LDR      R0,[SP, #+0]
...
//  366    	   RTC_TAR = 0x0;// Write 0 to disable
        MOVS     R0,#+0
        LDR      R1,??DataTable1_3  ;; 0x4003d008
        STR      R0,[R1, #+0]
