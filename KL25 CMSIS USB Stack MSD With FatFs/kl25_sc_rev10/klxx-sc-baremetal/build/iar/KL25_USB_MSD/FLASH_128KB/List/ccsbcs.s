...
//        FatFs\kl25_sc_rev10\klxx-sc-baremetal\src\projects\KL25_USB_MSD\FATFS\ccsbcs.c
//    Command line =  
//        "D:\My Project\SDCardJicheng\KL25 CMSIS USB Stack MSD With
//        FatFs\kl25_sc_rev10\klxx-sc-baremetal\src\projects\KL25_USB_MSD\FATFS\ccsbcs.c"
...
//    List file    =  
//        D:\My Project\SDCardJicheng\KL25 CMSIS USB Stack MSD With
//        FatFs\kl25_sc_rev10\klxx-sc-baremetal\build\iar\KL25_USB_MSD\FLASH_128KB\List\ccsbcs.s
//
///////////////////////////////////////////////////////////////////////////////
...
// D:\My Project\SDCardJicheng\KL25 CMSIS USB Stack MSD With FatFs\kl25_sc_rev10\klxx-sc-baremetal\src\projects\KL25_USB_MSD\FATFS\ccsbcs.c
//    1 /*------------------------------------------------------------------------*/
...
//  474 const uint16_t Tbl[] = {	/*  CP1258(0x80-0xFF) to Unicode conversion table */
Tbl:
        DATA
        DC16 8364, 0, 8218, 402, 8222, 8230, 8224, 8225, 710, 8240, 0, 8249
        DC16 338, 0, 0, 0, 0, 8216, 8217, 8220, 8221, 8226, 8211, 8212, 732
        DC16 8482, 0, 8250, 339, 0, 0, 376, 160, 161, 162, 163, 164, 165, 166
        DC16 167, 168, 169, 170, 171, 172, 173, 174, 175, 176, 177, 178, 179
        DC16 180, 181, 182, 183, 184, 185, 186, 187, 188, 189, 190, 191, 192
        DC16 193, 194, 258, 196, 197, 198, 199, 200, 201, 202, 203, 768, 205
        DC16 206, 207, 272, 209, 777, 211, 212, 416, 214, 215, 216, 217, 218
        DC16 219, 220, 431, 771, 223, 224, 225, 226, 259, 228, 229, 230, 231
        DC16 232, 233, 234, 235, 769, 237, 238, 239, 273, 241, 803, 243, 244
        DC16 417, 246, 247, 248, 249, 250, 251, 252, 432, 8363, 255
...
//  500 
        ...
        THUMB
//  501 uint16_t ff_convert (	/* Converted character, Returns zero on error */
//  502 	uint16_t	src,	/* Character code to be converted */
//  503 	uint32_t	dir		/* 0: Unicode to OEMCP, 1: OEMCP to Unicode */
//  504 )
//  505 {
ff_convert:
        PUSH     {LR}
...
??ff_convert_0:
        CMP      R1,#+0
        BEQ      ??ff_convert_2
//  514 			c = (uint16_t)((src >= 0x100) ? 0 : Tbl[src - 0x80]);
        UXTH     R0,R0
        CMP      R0,#+255
        BLE      ??ff_convert_3
        MOVS     R1,#+0
...
??ff_wtoupper_0:
        ...
        BNE      ??ff_wtoupper_1
//  538 
//  539 	return (uint16_t)(tbl_lower[i] ? tbl_upper[i] : chr);
??ff_wtoupper_2:
        LDR      R2,??DataTable1_1
        MOVS     R3,#+2
        MULS     R3,R1,R3
