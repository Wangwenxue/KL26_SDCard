...
//    List file    =  
//        D:\My Project\ZhiyunKangkai\KL25 CMSIS USB Stack MSD With
//        FatFs\kl25_sc_rev10\klxx-sc-baremetal\build\iar\platinum\FLASH_128KB\List\sysinit.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   48         if (PMC_REGSC &  PMC_REGSC_ACKISO_MASK)
        MOVS     R0,#+8
        LDR      R1,??DataTable2_1  ;; 0x4007d002
        LDRB     R2,[R1, #+0]
        TST      R2,R0
        BEQ      ??sysinit_0
...
//  115           PORTA_PCR1 = PORT_PCR_MUX(0x2);
        LDR      R0,??DataTable2_5  ;; 0x40049004
        LSRS     R1,R0,#+21
        STR      R1,[R0, #+0]
//  116           
...
//  153             uart0_init (UART0_BASE_PTR, uart0_clk_khz, TERMINAL_BAUD);
        ...
        LSLS     R2,R2,#+9        ;; #+115200
        LDR      R1,[R5, #+16]
        LDR      R0,??DataTable2_6  ;; 0x4006a000
        BL       uart0_init
...
//  165     PORTA_PCR4 = PORT_PCR_MUX(0x1); // GPIO is alt1 function for this pin
        LDR      R0,??DataTable2_7  ;; 0x40049010
        LSRS     R1,R0,#+22
        STR      R1,[R0, #+0]
//  166     
