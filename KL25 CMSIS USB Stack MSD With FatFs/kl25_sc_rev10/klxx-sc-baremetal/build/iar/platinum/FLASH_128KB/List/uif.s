...
//    List file    =  
//        D:\My Project\ZhiyunKangkai\KL25 CMSIS USB Stack MSD With
//        FatFs\kl25_sc_rev10\klxx-sc-baremetal\build\iar\platinum\FLASH_128KB\List\uif.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  249         for (index = 0; index < UIF_NUM_SETCMD; ++index)
        ...
        CMP      R6,#+1
        BLT      ??uif_cmd_set_1
        LDR      R4,??DataTable16_5
        ADR      R7,??DataTable16_6  ;; "%s\n"
        Nop      
        ADR.N    R5,OPTFMT
//  250         {
...
//  316                 UIF_SETCMDTAB[index].func(argc,argv);
        ...
        BLX      R2
//  317                 printf("\n\n");
        ADR      R0,??DataTable16_7  ;; 0x0A, 0x0A, 0x00, 0x00
??uif_cmd_show_3:
        BL       printf
//  318                 return;
        B        ??uif_cmd_show_8
